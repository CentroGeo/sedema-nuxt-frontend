...
onMounted(async () => {
  ...
  await Promise.all([
    !storeCatalogo.userInfo?.username
    ...
    <div class="menu-lateral-contenedor">
        ...
        <li>
          ...
          <ul>
            <li v-if="mostrarCapas">
              <nuxt-link to="/catalogo/explorar/capas">
                Capas geográficas
              </nuxt-link>
            </li>

            <li v-if="mostrarTablas">
              <nuxt-link to="/catalogo/explorar/tablas">
                Datos tabulados
              </nuxt-link>
            </li>
      ...
      <ul v-if="estaLogueado && mostrarSesion" class="lista-sesion">
        ...
        <li v-if="mostrarCargar">
          <nuxt-link to="/catalogo/cargar-archivos">
            Carga de archivos
          </nuxt-link>
        </li>

        <li v-if="mostrarServiciosRemotos">
          <nuxt-link to="/catalogo/servicios-remotos">
            Carga de servicios remotos
          </nuxt-link>
        </li>
        ...
        <li v-if="mostrarRevision && puedeRevisarSolicitudes">
          <nuxt-link
            :class="{
              ['router-link-active router-link-exact-active']:
                route.path.includes('/catalogo/revision-solicitudes/'),
            }"
