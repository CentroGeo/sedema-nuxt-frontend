            ...
            <div v-if="aporteSeleccionado">
              <div class="detalle-aporte__header m-b-2">
                ...
                <div class="detalle-aporte__acciones">
                  ...
                  />
                  <button class="btn-moderno-chico btn-desaprobar" @click="cambiarEstadoAporte(aporteSeleccionado.id, 'NO REVISADO')">
                    Desaprobar
                  </button>
                </div>
              </div>
...
@media (max-width:767px){
  ...
  .panel-aportes__busqueda { width: 100%; }
  .panel-aportes__busqueda input { width: 100%; }
  .tarjeta-aporte { padding: 14px; }
  .tarjeta-aporte__contenido { gap: 10px; }
  .detalle-aporte__header {
    display: flex;
    flex-direction: column;
    align-items: flex-start;
  ...
  .detalle-aporte__registrante { margin-top: 12px; }
  ...
  .detalle-aporte__acciones-finales { flex-direction: column; }
  .detalle-aporte__acciones-finales > * { width: 100%; }
  .grid-metadatos {
    display: flex;
    flex-direction: column;
    row-gap: 8px;
...
@media (max-width:480px){
  .revision-aportes { gap: 16px; }
  .tarjeta-aporte { padding: 12px; }
  .tarjeta-ficha { padding: 16px; }
  .detalle-aporte { gap: 18px; }
  .detalle-aporte__titulo h2 { font-size: 1.1rem; }
  .detalle-aporte__mapa .leaflet-container { height: 220px; }
  .detalle-aporte__galeria { grid-template-columns: 1fr; }
  .detalle-aporte__acciones { gap: 10px; }
  .detalle-aporte__acciones > * { width: 100%; }
  .detalle-aporte__registrante { margin-top: 12px; }
}

@media (max-width:360px){
  h2 { font-size: 1rem; }
  .tarjeta-aporte { padding: 10px; }
  .detalle-aporte { gap: 14px; }
  .detalle-aporte__galeria { gap: 10px; }
  .detalle-aporte__registrante { margin-top: 12px; }
}
</style>