    ...
    <template #visualizador>
      <main id="principal" class="contenedor m-b-10 m-t-3">
        ...
        <div class="revision-aportes__header m-b-3">
          <h2 class="revision-aportes__titulo">Revisión del estado de los aportes</h2>
            ...
            >
              <div class="detalle-aporte__header m-b-3">
                ...
                <div class="detalle-aporte__acciones">
                  ...
                  />
                  <button class="boton-secundario boton-chico btn-mensajes" @click="abrirMensajes">
                    Mensajes
                  </button>
                </div>
              </div>

              <div v-if="aporteSeleccionado" class="mapa-placeholder detalle-aporte__mapa m-b-3">
                <ClientOnly>
                  <SisdaiMapa
                    id="aportesmapa"
                    class="gema"
